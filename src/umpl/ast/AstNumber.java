...
public class AstNumber extends Ast {
    ...
    public static Parser<Ast> parser  = hexadigit.Many1().Chain(hexadigit.Many1().KeepRight(Parsers.Matches('%')).Opt()).KeepRight(Parsers.Matches("0x")).Alt(digit.Many1().Chain(digit.Many1().KeepRight(Parsers.Matches('%')).Opt())).Map(c-> {
